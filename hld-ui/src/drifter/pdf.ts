...
export function drifterToPdf(drifter: Drifter): Partial<SheetHLDv5> {
	return {
		...
		"Character Description": { value: newlines(drifter.identity.description), generateAppearance: true },
		Mission: { value: newlines(drifter.identity.mission), generateAppearance: true },
		Class: { value: drifter.features.drifterClass, generateAppearance: true },
		"Specialized Disciplines": { value: drifter.features.speciality, generateAppearance: true },
		Trait: { value: drifter.features.trait, generateAppearance: true },
		Knack: { value: drifter.features.knack, generateAppearance: true },
		...
		Conditions: { value: newlines(drifter.conditions.boons), generateAppearance: true },
		"Conditions 2": { value: newlines(drifter.conditions.burdens), generateAppearance: true },

		Inventory: { value: newlines(drifter.equipment.gear), generateAppearance: true },
		"Inventory 2": { value: newlines(drifter.equipment.gear2), generateAppearance: true },
		...
		"Advancement Tier-1": { value: drifter.advancement.namedAdvancements[0] || "", generateAppearance: true },
		"Advancement Tier0": { value: drifter.advancement.namedAdvancements[1] || "", generateAppearance: true },
		"Advancement Tier1": { value: drifter.advancement.namedAdvancements[2] || "", generateAppearance: true },
		"Advancement Tier2": { value: drifter.advancement.namedAdvancements[3] || "", generateAppearance: true },
		"Advancements Perks": { value: newlines(drifter.advancement.perks), generateAppearance: true },
		...
		Talents: { value: newlines(drifter.abilities.talentList), generateAppearance: true },
		"Talent-Passive-Effect": {
			value: newlines(drifter.abilities.passiveTalent.description),
			generateAppearance: true,
		},
		"Talent-Passive-Title": { value: drifter.abilities.passiveTalent.title, generateAppearance: true },
		"Talents 3": { value: newlines(drifter.abilities.talent1.description), generateAppearance: true },
		"Talent-1-Title": { value: drifter.abilities.talent1.title, generateAppearance: true },
		"Talents 4": { value: newlines(drifter.abilities.talent2.description), generateAppearance: true },
		"Talent-2-Title": { value: drifter.abilities.talent2.title, generateAppearance: true },
		"Talents 5": { value: newlines(drifter.abilities.talent3.description), generateAppearance: true },
		"Talent-3-Title": { value: drifter.abilities.talent3.title, generateAppearance: true },
		"Talents 6": { value: newlines(drifter.abilities.talent4.description), generateAppearance: true },
		"Talent-4-Title": { value: drifter.abilities.talent4.title, generateAppearance: true },
		"Talents 7": { value: newlines(drifter.abilities.dashTalent.description), generateAppearance: true },
